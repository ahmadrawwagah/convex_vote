...
var import_react3 = require("../react/index.js");
function ConvexProviderWithAuth0({
  children,
  client
}) {
  return /* @__PURE__ */ import_react.default.createElement(import_react3.ConvexProviderWithAuth, { client, useAuth: useAuthFromAuth0 }, children);
}
function useAuthFromAuth0() {
  const { isLoading, isAuthenticated, getAccessTokenSilently } = (0, import_auth0_react.useAuth0)();
  const fetchAccessToken = (0, import_react2.useCallback)(async () => {
    try {
