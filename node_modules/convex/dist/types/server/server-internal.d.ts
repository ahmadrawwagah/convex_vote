 ...
 * @public
 */
export declare type CronJobsForAPI<API extends GenericAPI> = () => {
    /** @internal */
 ...
 * @public
 */
declare class Crons<API extends GenericAPI> {
    crons: Record<string, CronJob>;
    isCrons: true;
    constructor();
    /** @internal */
    schedule<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, schedule: Schedule, name: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /**
     ...
     * @param functionName - The name of the function to schedule.
     */
    interval<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, schedule: Interval, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /**
     * Schedule a mutation or action to run on a daily basis.
     *
     * ```js
     ...
     * @param functionName - The name of the function to schedule.
     */
    hourly<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, schedule: Hourly, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /**
     * Schedule a mutation or action to run on a daily basis.
     *
     * ```js
     ...
     * @param functionName - The name of the function to schedule.
     */
    daily<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, schedule: Daily, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /**
     * Schedule a mutation or action to run on a weekly basis.
     *
     * ```js
     ...
     * @param functionName - The name of the function to schedule.
     */
    weekly<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, schedule: Weekly, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /**
     * Schedule a mutation or action to run on a monthly basis.
     *
     * Note that some months have fewer days than others, so e.g. a function
     ...
     * @param functionName - The name of the function to schedule.
     */
    monthly<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, schedule: Monthly, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /**
     * Schedule a mutation or action to run on a recurring basis.
     *
     * Like the unix command `cron`, Sunday is 0, Monday is 1, etc.
     ...
     * @param functionName - The name of the function to schedule.
     */
    cron<Name extends SchedulableFunctionNames<API>>(cronIdentifier: string, cron: CronString, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>): void;
    /** @internal */
    export(): string;
}
 ...
 * @public
 */
export declare interface HttpEndpointCtx<API extends GenericAPI> {
    /**
     * Runs the Convex query with the given name and arguments.
     *
     * Consider using an {@link internalQuery} to prevent users from calling the
...
export declare class HttpRouter {
     ...
     */
    lookup: (path: string, method: RoutableMethod | "HEAD") => Readonly<[PublicHttpEndpoint<any>, RoutableMethod, string]> | null;
    /**
 ...
 * @public
 */
export declare type InternalAction<API extends GenericAPI, Args extends any[], Output> = {
    args: Args;
    output: Output;
 ...
 * @public
 */
export declare type InternalActionBuilderForAPI<API extends GenericAPI> = <Args extends any[], Output>(func: (ctx: ActionCtx<API>, ...args: Args) => Output) => InternalAction<API, Args, Output>;
 ...
 * @public
 */
export declare type InternalMutation<DataModel extends GenericDataModel, API extends GenericAPI, Args extends any[], Output> = {
    args: Args;
    output: Output;
 ...
 * @public
 */
export declare type InternalMutationBuilder<DataModel extends GenericDataModel, API extends GenericAPI> = <Args extends any[], Output>(func: (ctx: MutationCtx<DataModel, API>, ...args: Args) => Output) => InternalMutation<DataModel, API, Args, Output>;
 ...
 * @public
 */
export declare type InternalQuery<DataModel extends GenericDataModel, Args extends any[], Output> = {
    args: Args;
    output: Output;
 ...
 * @public
 */
export declare type InternalQueryBuilderForDataModel<DataModel extends GenericDataModel> = <Args extends any[], Output>(func: (ctx: QueryCtx<DataModel>, ...args: Args) => Output) => InternalQuery<DataModel, Args, Output>;
 ...
 * @public
 */
export declare interface StorageHttpWriter extends StorageWriter {
    /**
