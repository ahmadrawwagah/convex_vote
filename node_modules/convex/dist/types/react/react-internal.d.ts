 ...
 * @public
 */
export declare type PaginatedQueryNames<API extends GenericAPI> = keyof PickByValue<API["publicQueries"], PaginatedQueryFunction<any, any>> & string;
 ...
 * @public
 */
export declare type UseQueryForAPI<API extends GenericAPI> = <Name extends PublicQueryNames<API>>(name: Name, ...args: Parameters<NamedQuery<API, Name>>) => ReturnType<NamedQuery<API, Name>> | undefined;
 ...
 * @public
 */
export declare function useQueryGeneric<API extends GenericAPI, Name extends PublicQueryNames<API>>(name: Name, ...args: Parameters<NamedQuery<API, Name>>): ReturnType<NamedQuery<API, Name>> | undefined;
 ...
 * @internal
 */
export declare function useQueryInternal<API extends GenericAPI, Name extends PublicQueryNames<API>>(convex: ConvexReactClient<API>, name: Name, ...args: Parameters<NamedQuery<API, Name>>): ReturnType<NamedQuery<API, Name>> | undefined;
...
/** @internal */
declare type UserIdentityAttributes = Omit<UserIdentity, "updatedAt" | "issuer"> & {
    updatedAt?: string;
};
