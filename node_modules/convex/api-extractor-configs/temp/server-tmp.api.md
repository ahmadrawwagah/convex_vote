...
//
// @public
export type ActionBuilderForAPI<API extends GenericAPI> = <Args extends any[], Output>(func: (ctx: ActionCtx<API>, ...args: Args) => Output) => PublicAction<Args, Output>;
...
// @public
export const actionGeneric: <API extends GenericAPI, Args extends any[], Output>(func: (ctx: ActionCtx<API>, ...args: Args) => Output) => PublicAction<Args, Output>;
...
export type CronJobsForAPI<API extends GenericAPI> = () => {
    schedule: <Name extends SchedulableFunctionNames<API>>(identifier: string, schedule: Schedule, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    interval: <Name extends SchedulableFunctionNames<API>>(identifier: string, schedule: Interval, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    hourly: <Name extends SchedulableFunctionNames<API>>(identifier: string, schedule: Hourly, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    daily: <Name extends SchedulableFunctionNames<API>>(identifier: string, schedule: Daily, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    weekly: <Name extends SchedulableFunctionNames<API>>(identifier: string, schedule: Weekly, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    monthly: <Name extends SchedulableFunctionNames<API>>(identifier: string, schedule: Monthly, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    cron: <Name extends SchedulableFunctionNames<API>>(identifier: string, cron: CronString, functionName: Name, ...args: Parameters<NamedSchedulableFunction<API, Name>>) => void;
    export: () => string;
};

// Warning: (ae-forgotten-export) The symbol "Crons" needs to be exported by the entry point index.d.ts
//
// @public
...
// @public
export type HttpEndpointBuilderForAPI<API extends GenericAPI> = (func: (ctx: HttpEndpointCtx<API>, request: Request) => Promise<Response>) => PublicHttpEndpoint;
...
// @public
export const httpEndpointGeneric: <API extends GenericAPI>(func: (ctx: HttpEndpointCtx<API>, request: Request) => Promise<Response>) => PublicHttpEndpoint;

// @public
export class HttpRouter {
    // (undocumented)
    exactRoutes: Map<string, Map<RoutableMethod, PublicHttpEndpoint>>;
    getRoutes: () => (readonly [string, "POST" | "GET" | "PUT" | "DELETE" | "OPTIONS" | "PATCH", (...args: any[]) => any])[];
    // (undocumented)
    isRouter: boolean;
    lookup: (path: string, method: RoutableMethod | "HEAD") => Readonly<[PublicHttpEndpoint, RoutableMethod, string]> | null;
    // (undocumented)
    prefixRoutes: Map<RoutableMethod, Map<string, PublicHttpEndpoint>>;
...
// @public
export type InternalAction<Args extends any[], Output> = {
    args: Args;
    output: Output;
    isAction: true;
    isInternal: true;
...
// @public
export type InternalActionBuilderForAPI<API extends GenericAPI> = <Args extends any[], Output>(func: (ctx: ActionCtx<API>, ...args: Args) => Output) => InternalAction<Args, Output>;

// @public
export const internalActionGeneric: <API extends GenericAPI, Args extends any[], Output>(func: (ctx: ActionCtx<API>, ...args: Args) => Output) => InternalAction<Args, Output>;

// @public
export type InternalMutation<Args extends any[], Output> = {
    args: Args;
    output: Output;
    isMutation: true;
    isInternal: true;
...
// @public
export type InternalMutationBuilder<DataModel extends GenericDataModel, API extends GenericAPI> = <Args extends any[], Output>(func: (ctx: MutationCtx<DataModel, API>, ...args: Args) => Output) => InternalMutation<Args, Output>;

// @public
export const internalMutationGeneric: <DataModel extends GenericDataModel, API extends GenericAPI, Args extends any[], Output>(func: (ctx: MutationCtx<DataModel, API>, ...args: Args) => Output) => InternalMutation<Args, Output>;

// @public
export type InternalQuery<Args extends any[], Output> = {
    args: Args;
    output: Output;
    isQuery: true;
    isInternal: true;
...
// @public
export type InternalQueryBuilderForDataModel<DataModel extends GenericDataModel> = <Args extends any[], Output>(func: (ctx: QueryCtx<DataModel>, ...args: Args) => Output) => InternalQuery<Args, Output>;

// @public
export const internalQueryGeneric: <DataModel extends GenericDataModel, Args extends any[], Output>(func: (ctx: QueryCtx<DataModel>, ...args: Args) => Output) => InternalQuery<Args, Output>;

// @public
export type MutationBuilder<DataModel extends GenericDataModel, API extends GenericAPI> = <Args extends any[], Output>(func: (ctx: MutationCtx<DataModel, API>, ...args: Args) => Output) => PublicMutation<Args, Output>;

// @public
export type MutationCtx<DataModel extends GenericDataModel, API extends GenericAPI> = {
...
// @public
export const mutationGeneric: <DataModel extends GenericDataModel, API extends GenericAPI, Args extends any[], Output>(func: (ctx: MutationCtx<DataModel, API>, ...args: Args) => Output) => PublicMutation<Args, Output>;
...
// @public
export type PublicAction<Args extends any[], Output> = {
    args: Args;
    output: Output;
    isAction: true;
    isPublic: true;
...
// @public
export type PublicHttpEndpoint = {
    (ctx: HttpEndpointCtx<any>, request: Request): Response;
    isHttp: true;
    isRegistered?: true;
...
// @public
export type PublicMutation<Args extends any[], Output> = {
    args: Args;
    output: Output;
    isMutation: true;
    isPublic: true;
...
// @public
export type PublicQuery<Args extends any[], Output> = {
    args: Args;
    output: Output;
    isQuery: true;
    isPublic: true;
...
// @public
export type QueryBuilderForDataModel<DataModel extends GenericDataModel> = <Args extends any[], Output>(func: (ctx: QueryCtx<DataModel>, ...args: Args) => Output) => PublicQuery<Args, Output>;
...
// @public
export const queryGeneric: <DataModel extends GenericDataModel, Args extends any[], Output>(func: (ctx: QueryCtx<DataModel>, ...args: Args) => Output) => PublicQuery<Args, Output>;
...
//
// src/server/cron.ts:203:3 - (ae-forgotten-export) The symbol "SchedulableFunctionNames" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:203:3 - (ae-forgotten-export) The symbol "NamedSchedulableFunction" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:221:3 - (ae-forgotten-export) The symbol "Interval" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:245:3 - (ae-forgotten-export) The symbol "Hourly" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:270:3 - (ae-forgotten-export) The symbol "Daily" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:295:3 - (ae-forgotten-export) The symbol "Weekly" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:324:3 - (ae-forgotten-export) The symbol "Monthly" needs to be exported by the entry point index.d.ts
// src/server/cron.ts:349:3 - (ae-forgotten-export) The symbol "CronString" needs to be exported by the entry point index.d.ts
